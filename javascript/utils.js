...
window.ARedSecret.utils = {
    ...
    getBasicSkillLevelFromScore: function (score) {
        if (score >= 1000) { return "<span class=\"green\">S</span>"; }
        else if (score < 1000 && score >= 800) { return "<span class=\"teal\">A</span>"; }
        else if (score < 800 && score >= 600) { return "<span class=\"lblue\">B</span>"; }
        else if (score < 600 && score >= 400) { return "<span class=\"blue\">C</span>"; }
        else if (score < 400 && score >= 200) { return "<span class=\"purple\">D</span>"; }
        else if (score < 200 && score >= 1) { return "<span class=\"pink\">F</span>"; }
        else { return "<span class=\"red\">$ARedSecret.loc.none</span>"; }
    },
    getDetailedSkillLevelFromScore: function (score) {
        if (score >= 1000) { return "<span class=\"green\">S</span>"; }
